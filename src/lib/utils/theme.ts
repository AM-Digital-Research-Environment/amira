/**
 * Theming helpers — research-section colour token resolution.
 *
 * Charts (ECharts, MapLibre overlays) render to canvas and can't read CSS
 * variables, so they need literal `hsl(...)` strings. This module owns the
 * mapping from section name → CSS variable → resolved colour.
 */
